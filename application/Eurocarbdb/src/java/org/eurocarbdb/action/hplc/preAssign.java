...
//string required for refining displayed glycans
    ...
    String queryRefineComplete = "from HplcPeaksAnnotated HP join HP.glycan G where HP.profileId = 46 and " + queryAnd + " order by HP.gu";
...
List displayCriteria = criteria.list();
    ...
    if (criteriaSelection <= 0) {
        ...
        display = getEntityManager().getQuery("org.eurocarbdb.dataaccess.hplc.HplcPeaksAnnotated.PRE_ASSIGN_DISPLAY")
...
//test deleting records
    ...
    List  afterDelete = getEntityManager().getQuery("org.eurocarbdb.dataaccess.hplc.HplcPeaksAnnotated.PRE_ASSIGN_DISPLAY")
        .setParameter("parent", profile_id)
        .list();
