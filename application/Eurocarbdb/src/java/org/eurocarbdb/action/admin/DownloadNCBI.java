...
*   @version  $Rev: 1932 $
*/
public class DownloadNCBI extends AbstractDownloadAction implements org.eurocarbdb.action.RequiresAdminLogin 
{

    //~~~~~~~~~~~~~~~~~~~~~~~~~~ FIELDS ~~~~~~~~~~~~~~~~~~~~~~~~~~~//

    /** Logging handle. */
    private static final Log log = LogFactory.getLog( DownloadNCBI.class );
    ...
    */
    public String execute()
    {
        ...
        String localfile  = Eurocarb.getProperty("ncbi.taxonomy.localfile");
        URI    ncbi_uri   = Eurocarb.getPropertyAsURI("ncbi.taxonomy.url");
