...
public class ExampleUsage {
    ...
    public static void main(String[] args) throws ResourcesDbException, SugarImporterException, GlycoVisitorException {
        ...
        //g2
        t_strCode = "[][A-D-MANP]{[(2+1)][B-D-MANF]{[(2/3+1)][A-D-MANP]{}}}";
        ...
        // compare
        MCSFuzzy t_oComp = new MCSFuzzy (g2,g1);
        
        t_oComp.setAnomerSensitivity(false);
        t_oComp.setExactLinkageMatch(false);
        t_oComp.setRingsizeSensitivity(false);
