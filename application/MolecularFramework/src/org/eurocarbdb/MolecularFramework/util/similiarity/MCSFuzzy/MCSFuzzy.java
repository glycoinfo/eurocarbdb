...
public class MCSFuzzy {
    ...
    public MCSFuzzy (Sugar g1, Sugar g2){
    ...
    void recursionMakeSugar (GlycoNode root, ArrayList<GlycoNode> a_Nodes1, ArrayList<GlycoNode> a_Nodes2){
        ...
        MCSNodeComparatorFuzzy t_oNodeComparator = new MCSNodeComparatorFuzzy(this);
        MCSEdgeComparatorFuzzy t_oCompEdge = new MCSEdgeComparatorFuzzy(this);    
