...
*
*/
public class ESMVisitorFuzzy implements GlycoVisitor {

    String m_sName;
    ESMFuzzy m_oMCSFuzzy = null;
    
    public ESMVisitorFuzzy (ESMFuzzy m){
        this.m_oMCSFuzzy=m;
    }
    ...
    public void visit(Monosaccharide a_objMonosaccharid) throws GlycoVisitorException {
        ...
        t_oNameExporter.displayConfiguration(this.m_oMCSFuzzy.m_bConfiguration);
