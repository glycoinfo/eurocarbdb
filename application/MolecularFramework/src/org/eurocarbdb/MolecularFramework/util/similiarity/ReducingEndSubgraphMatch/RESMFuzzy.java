...
public class RESMFuzzy {
    ...
    public RESMFuzzy (Sugar target, Sugar query){
        
        
        
        try {
            
            this.m_aTarget = target.getRootNodes();
    ...
    void recursionMakeSugar (GlycoNode root, ArrayList<GlycoNode> a_Nodes1, ArrayList<GlycoNode> a_Nodes2){
        ...
        RESMNodeComparatorFuzzy t_oNodeComparator = new RESMNodeComparatorFuzzy(this);
        RESMEdgeComparatorFuzzy t_oCompEdge = new RESMEdgeComparatorFuzzy(this);    
