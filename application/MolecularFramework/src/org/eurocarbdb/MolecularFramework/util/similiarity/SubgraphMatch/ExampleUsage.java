...
public class ExampleUsage {
     ...
     */
    public static void main(String[] args) throws ResourcesDbException, SugarImporterException, GlycoVisitorException, GlycoconjugateException {
        SugarImporter t_objImporter = new SugarImporterLinucs();
        Config t_objConf = new Config();
        //g1
        String t_strCode = "[][A-D-GLCPNAC]{[(4+1)][D-GLCNAC-ol]{[(4+1)][B-D-MANP]{[(3+1)][A-D-MANP3ME]{[(2+1)][A-D-MANP]{[(2+1)][A-D-MANP]{}}}[(6+1)][A-D-MANP]{[(3+1)][A-D-MANP]{}[(6+1)][A-D-MANP]{[(2+1)][A-D-MANP]{}}}}}}";
        ...
        //g2
        t_strCode = "[][B-D-GLCPNAC]{[(4+1)][D-GLCNAC-ol]{}}";
        ...
        // compare
        ESMFuzzy t_oComp = new ESMFuzzy (g1,g2);
        ...
        t_oComp.setOnlyTopology(false);
        
        ArrayList <GlycoNode> a = new ArrayList <GlycoNode> ();
        a.add(g1.getRootNodes().get(0));        
        t_oComp.setResidueAnomerIgnorable(a);
        ...
        t_oComp.plotMatrix();
            ...
            System.out.println("\n"+t_exporter.getHashCode()+"\n Query structure is contained: "+String.valueOf(t_oComp.isContained()));
            }
            else {
