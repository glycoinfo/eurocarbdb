...
<TR>
    ...
    <td>
        ...
        <tr>
            ...
            <TD class="gpf_table_menu_button" width="95"><img border="0" src="./images/structures_unselect.jpg" onclick="js:switchToPage('stru');" onmouseover="getElementById('menu_stru').src='./images/structures_over.jpg'" onmouseout="getElementById('menu_stru').src='./images/structures_unselect.jpg'" id='menu_stru' width="100%"></TD>
            <TD class="gpf_table_menu_space" width="20"/>
            <TD class="gpf_table_menu_button" width="95"><img border="0" src="./images/settings_select.jpg" width="100%"></TD>
