...
<TR>
    ...
    <td>
        ...
        <tr>
            ...
            <TD class="gpf_table_menu_button" width="95"><img border="0" src="./images/residue_unselect.jpg" onclick="js:switchToPage('resi');" onmouseover="getElementById('menu_resi').src='./images/residue_over.jpg'" onmouseout="getElementById('menu_resi').src='./images/residue_unselect.jpg'" id='menu_resi' width="100%"></TD>
            <TD class="gpf_table_menu_space" width="20"/>
            <TD class="gpf_table_menu_button" width="95"><img border="0" src="./images/ion_select.jpg" width="100%"></TD>
            <TD class="gpf_table_menu_space" width="20"/>
