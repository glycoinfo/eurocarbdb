...
<form method="POST" action="${baseUrl}/Input.action" name="values" enctype="multipart/form-data">
...
<TR>
    ...
    <td>
    	...
    	<tr>
            ...
            <TD class="gpf_table_menu_button" width="95"><img border="0" src="./images/mass_select.jpg" width="100%"></TD>
            <TD class="gpf_table_menu_space" width="20"/>
            <TD class="gpf_table_menu_button" width="95"><img border="0" src="./images/residue_unselect.jpg" onclick="js:clearFileSettings('true');switchToPage('resi');" onmouseover="getElementById('menu_resi').src='./images/residue_over.jpg'" onmouseout="getElementById('menu_resi').src='./images/residue_unselect.jpg'" id='menu_resi' width="100%"></TD>
            <TD class="gpf_table_menu_space" width="20"/>
            <TD class="gpf_table_menu_button" width="95"><img border="0" src="./images/ion_unselect.jpg" onclick="js:clearFileSettings('true');switchToPage('ions');" onmouseover="getElementById('menu_ions').src='./images/ion_over.jpg'" onmouseout="getElementById('menu_ions').src='./images/ion_unselect.jpg'" id='menu_ions' width="100%"></TD>
            <TD class="gpf_table_menu_space" width="20"/>
            <TD class="gpf_table_menu_button" width="95"><img border="0" src="./images/modifications_unselect.jpg" onclick="js:clearFileSettings('true');switchToPage('modi');" onmouseover="getElementById('menu_modi').src='./images/modifications_over.jpg'" onmouseout="getElementById('menu_modi').src='./images/modifications_unselect.jpg'" id='menu_modi' width="100%"></TD>
