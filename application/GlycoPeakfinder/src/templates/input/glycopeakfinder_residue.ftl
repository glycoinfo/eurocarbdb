...
<TR>
    ...
    <td>
    	...
    	<tr>
            ...
            <TD class="gpf_table_menu_button" width="95"><img border="0" src="./images/mass_unselect.jpg" onclick="js:switchToPage('mass');" onmouseover="getElementById('menu_mass').src='./images/mass_over.jpg'" onmouseout="getElementById('menu_mass').src='./images/mass_unselect.jpg'" id='menu_mass' width="100%"></TD>
            <TD class="gpf_table_menu_space" width="20"/>
            <TD class="gpf_table_menu_button" width="95"><img border="0" src="./images/residue_select.jpg" id='menu_resi' width="100%"></TD>
            <TD class="gpf_table_menu_space" width="20"/>
            <TD class="gpf_table_menu_button" width="95"><img border="0" src="./images/ion_unselect.jpg" onclick="js:switchToPage('ions');" onmouseover="getElementById('menu_ions').src='./images/ion_over.jpg'" onmouseout="getElementById('menu_ions').src='./images/ion_unselect.jpg'" id='menu_ions' width="100%"></TD>
            <TD class="gpf_table_menu_space" width="20"/>
            <TD class="gpf_table_menu_button" width="95"><img border="0" src="./images/modifications_unselect.jpg" onclick="js:switchToPage('modi');" onmouseover="getElementById('menu_modi').src='./images/modifications_over.jpg'" onmouseout="getElementById('menu_modi').src='./images/modifications_unselect.jpg'" id='menu_modi' width="100%"></TD>
