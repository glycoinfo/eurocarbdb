...
*
*/
public class LoadResultAction extends GlycoPeakfinderAction
{
    ...
    public LoadResultAction()
    {
        this.m_strPageType = "load_result";
    }

    public void setLoadResult(File a_fFile)
    {
        this.m_hFile = a_fFile;
    }

    public File getLoadResult()
    {
        return this.m_hFile;
    }

    public void setLoadResultContentType(String a_strContentType)
    {
        this.m_strFileType = a_strContentType;
    }

    public String getLoadResultContentType()
    {
        return this.m_strFileType;
    }

    public void setLoadResultFileName(String a_strFilename)
    {
        this.m_strFileName = a_strFilename;
    }

    public String getLoadResultFileName()
    {
     ...
     public String execute() throws Exception
     {
         ...
         if ( this.m_strExtension.equalsIgnoreCase("gpxml") )
         {
             try
             {
                 ...
                 this.m_objResult.createFromParameter(t_objParam, this.m_objSettings.getDerivatisation(), this.m_objSettings.getOtherModificationName(),this.m_objSettings);
                 if ( this.m_objSettings.getErrorList().size() != 0 )
                 {
                     ...
                     this.m_objError.setTitle("Unable to load results");
                     this.m_objError.setBackUrl("LoadResult.action");
                     return "page_error";
                 }
