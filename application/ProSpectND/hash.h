...
static unsigned int hash_ptr (cache_ptr cache, const void *key)
{
...
/* Calculate a hash code by iterating over a NULL 
   terminate string.  */
static unsigned int hash_string (cache_ptr cache, const void *key)
{
  unsigned int ret = 0;
  unsigned int ctr = 0;
  char *key2 = (char*) key;
...
static int compare_ptrs (const void *k1, const void *k2)
{
...
/* Compare two strings.  */
static int compare_strings (const void *kk1, const void *kk2)
{
    char *k1, *k2;
    k1 = (char*) kk1;
    k2 = (char*) kk2;
