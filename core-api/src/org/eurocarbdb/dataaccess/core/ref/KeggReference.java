...
*   @author mjh
*/
public class KeggReference 
extends ExternalDatabaseReference implements Serializable
{
    /** Default query base URL for constructing links */
    public static final String Default_Kegg_Query_Url 
        = "http://www.genome.jp/dbget-bin/www_bget?gl:";
    
    static final Logger log = Logger.getLogger( KeggReference.class );

//    private static final String Q = "org.eurocarbdb.dataaccess.core.KeggReference."; 
    ...
    /** default constructor */
    public KeggReference() 
    {
        //  default journal reference provider is pubmed.
        setExternalReferenceName("kegg");
    ...
    /** 
    *   Returns Kegg id; this should be the same id as 
    ...
    */
    ...
    public String getUrl()
    {
        ...
        String base = Eurocarb.getProperty("kegg.query.url");
        if ( base == null || base.length() == 0 || ! base.startsWith("http://") )
            base = Default_Kegg_Query_Url;
        
        String id = this.getKeggId(); 
