...
*   @author mjh
*/
public class GlyaffinityReference 
extends ExternalDatabaseReference implements Serializable
{
    /** Default query base URL for constructing links */
    public static final String Default_Glyaffinity_Query_Url 
        = "";
    
    static final Logger log = Logger.getLogger( GlyaffinityReference.class );

//    private static final String Q = "org.eurocarbdb.dataaccess.core.GlyaffinityReference."; 
    ...
    /** default constructor */
    public GlyaffinityReference() 
    {
        //  default journal reference provider is pubmed.
        setExternalReferenceName("glyaffinity");
    ...
    /** 
    *   Returns Glyaffinity id; this should be the same id as 
    *   {@link Reference#getExternalReferenceId()} 
    */
    public String getGlyaffinityId()
    {
    ...
    public String getUrl()
    {
        ...
        String base = Eurocarb.getProperty("glyaffinity.query.url");
        if ( base == null || base.length() == 0 || ! base.startsWith("http://") )
            base = Default_Glyaffinity_Query_Url;
        
        String id = this.getGlyaffinityId(); 
